...
variant: "alt-v3"
supersedes: null
superseded_by: "B-6.2-server-actions.md"
source: "archive/html-v3/archive/build-guide-v3.html"
---

> **Variant.** This is the `build-guide-v3` wording of `B-6.2`. The canonical version
> is [`B-6.2-server-actions.md`](B-6.2-server-actions.md). Both were frozen in the same commit and their
