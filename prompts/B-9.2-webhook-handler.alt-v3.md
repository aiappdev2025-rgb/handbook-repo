...
variant: "alt-v3"
supersedes: null
superseded_by: "B-9.2-webhook-handler.md"
source: "archive/html-v3/archive/build-guide-v3.html"
---

> **Variant.** This is the `build-guide-v3` wording of `B-9.2`. The canonical version
> is [`B-9.2-webhook-handler.md`](B-9.2-webhook-handler.md). Both were frozen in the same commit and their
