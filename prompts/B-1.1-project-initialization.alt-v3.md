...
variant: "alt-v3"
supersedes: null
superseded_by: "B-1.1-project-initialization.md"
source: "archive/html-v3/archive/build-guide-v3.html"
---

> **Variant.** This is the `build-guide-v3` wording of `B-1.1`. The canonical version
> is [`B-1.1-project-initialization.md`](B-1.1-project-initialization.md). Both were frozen in the same commit and their
