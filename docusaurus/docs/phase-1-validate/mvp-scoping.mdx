...
- Have your Business One-Pager and Competitive Analysis ready

**What to expect:**
- Takes 10-15 minutes
- Creates clear feature priorities with MoSCoW method
- You'll save the output manually to `docs/mvp-scope.md`
</HowToRun>

<SmartPrompt
  artifactId="mvp-scope"
  title="MVP Scoping Prompt"
  template={`Define MVP scope for [PRODUCT_NAME].
