...
- Have your Business One-Pager complete for context

**What to expect:**
- Claude uses web search to research competitors
- Takes 15-20 minutes for thorough analysis
- You'll save the output manually to `docs/competitive-analysis.md`
</HowToRun>

<SmartPrompt
  artifactId="competitive-analysis"
