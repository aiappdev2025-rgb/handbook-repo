...
- Have your UX Package complete for review

**What to expect:**
- Identifies usability issues before implementation
- Takes 10-15 minutes
- May result in updates to your UX Package
</HowToRun>

<SmartPrompt
  artifactId="user-flows"
  title="UX Flows Critique Prompt"
  template={`Review the UX flows for [PRODUCT_NAME] as a UX expert.
