...
```markdown
Create an API specification for [PRODUCT NAME] based on the architecture.

For each endpoint, document:
1. HTTP method and route
2. Purpose (what it does)
3. Authentication requirement
4. Request body/query params schema
5. Success response schema
6. Error responses (400, 401, 403, 404, 500)

Group endpoints by resource:
- /api/auth/* (authentication)
- /api/users/* (user management)
- /api/[domain]/* (domain-specific)
- /api/ai/* (AI features)
- /api/billing/* (Stripe integration)

Include validation rules for all request fields.
