...
- Have your tech stack decisions ready (from Solution Architecture)

**What Claude Code will do:**
- Create the `docs/adrs/` folder if it doesn't exist
- Generate 3-5 ADR files based on your tech stack
- Save each ADR as a numbered markdown file
- Create the ADR template for future use
</HowToRun>

<SmartPrompt
  artifactId="adr-templates"
  title="Generate ADRs Prompt"
  template={`Create Architecture Decision Records for [PRODUCT_NAME].
